        ...
        <div className="p-6 relative">
          ...
          {isProcessing && (
            <div className="absolute inset-0 bg-white bg-opacity-75 flex items-center justify-center z-10">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 font-medium">Đang xóa danh mục...</p>
              </div>
            </div>
          )}
          ...
          <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-red-700 text-sm flex items-start">
              ...
              <span>
                <strong>Cảnh báo:</strong> Hành động này không thể hoàn tác và sẽ xóa tất cả dữ liệu liên quan bao gồm các câu hỏi trong danh mục này.
              </span>
            </p>
          </div>
        </div>
